            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('${enrollment['course_name'] ?? enrollment['class_name'] ?? 'Khóa học'}', style: const TextStyle(fontWeight: FontWeight.w600)),
                  const SizedBox(height: 20),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('${e['course_name'] ?? e['class_name'] ?? 'Khóa học'}', style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                                      const SizedBox(height: 8),
